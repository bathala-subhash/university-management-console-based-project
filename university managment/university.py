...
while True:
    ...
    if x == 1:
        ...
        n=int(input("enter no.of teachers: "))
        for _ in range(n):
            clgname = input("Enter COllege Name: ")
            temp = False
            for x in colleges:
        ...
        coname = input("Enter College Name: ")
        ...
        if found_college:
            found = False
            for student in found_college.students:
            ...
            if not found:
                print()
                print("Student Not Found in the College.")
        else:
            print()
        ...
        coname = input("Enter College Name: ")
        rollno = input("Enter Roll No of Teacher: ")
        found_college = None
        for clg in colleges:
            if clg.cname == coname:
                found_college = clg
        ...
        if found_college:
            found = False
            for teacher in found_college.teachers:
            ...
            if not found:
                print()
                print("Teacher Not Found in the College.")
        else:
            print()
            print("College Does Not Exist!")
